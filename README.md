...
[![ci](https://github.com/MarkRakhmatov/ExampleStaticLibA/actions/workflows/ci.yml/badge.svg)](https://github.com/MarkRakhmatov/ExampleStaticLibA/actions/workflows/ci.yml)

## About ExampleStaticLibA
...
### Usage
#### CMake
To use ExampleStaticLibA library in cmake project:

```
CPMAddPackage("gh:MarkRakhmatov/ExampleStaticLibA@v0.1.0")
```

Link ExampleStaticLibA library to your target
```
target_link_libraries(your_target PRIVATE ExampleStaticLibA)
```
